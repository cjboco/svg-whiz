      ...
      <div className='flex items-center justify-between'>
        <div className='flex gap-2'>
          <button
            ...
            className={`flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-semibold font-[Helvetica,Arial,sans-serif] transition-colors ${viewMode === 'view'
          ...
          <button
            ...
            className={`flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-semibold font-[Helvetica,Arial,sans-serif] transition-colors ${viewMode === 'edit'
                ? 'bg-fuchsia-100 dark:bg-fuchsia-900/30 text-fuchsia-700 dark:text-fuchsia-300'
                : 'bg-zinc-100 dark:bg-zinc-800 text-zinc-600 dark:text-zinc-400 hover:bg-zinc-200 dark:hover:bg-zinc-700'
              }`}
          >
        ...
        {viewMode === 'edit' && (
          <div className='flex gap-2'>
            <button
              ...
              className='flex items-center gap-2 px-3 py-2 bg-zinc-100 dark:bg-zinc-800 text-zinc-600 dark:text-zinc-400 hover:bg-zinc-200 dark:hover:bg-zinc-700 rounded-lg text-sm font-semibold font-[Helvetica,Arial,sans-serif] transition-colors'
            >
            ...
            <button
              ...
              className='flex items-center gap-2 px-3 py-2 bg-fuchsia-600 hover:bg-fuchsia-700 text-white rounded-lg text-sm font-semibold font-[Helvetica,Arial,sans-serif] transition-colors'
            >
              Apply
            </button>
          </div>
        ...
        <div className='flex flex-wrap gap-2'>
          {[
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded text-sm font-medium transition-colors ${outputMode === mode.id
                  ? 'bg-fuchsia-100 dark:bg-fuchsia-900/30 text-fuchsia-700 dark:text-fuchsia-300'
                  : 'bg-zinc-100 dark:bg-zinc-800 text-zinc-600 dark:text-zinc-400 hover:bg-zinc-200 dark:hover:bg-zinc-700'
                }`}
            >
