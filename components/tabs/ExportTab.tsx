  ...
  return (
    <div className='space-y-6'>
      ...
      <button
        ...
        className='w-full flex items-center justify-center gap-2 bg-fuchsia-600 hover:bg-fuchsia-700 disabled:bg-fuchsia-400 text-white font-semibold font-[Helvetica,Arial,sans-serif] py-3 px-6 rounded-lg transition-colors'
      >
