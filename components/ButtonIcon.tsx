...
const ButtonIcon = ({
  ...
  const baseClasses =
    'inline-flex items-center appearance-none border-0 rounded-lg text-white font-semibold font-[Helvetica,Arial,sans-serif] transition-all duration-150 cursor-pointer';
